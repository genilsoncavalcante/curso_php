         ...
         <div class="col-md-6 offset-md-1">
            ...
            <form id="edit-movie-form" action="<?php echo $BASE_URL; ?>/movie_process.php" method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group">
                  ...
                  <input type="text" name="title" class="form-control" id="title" placeholder="Digite o título do seu filme" value="<?php echo $movie->title; ?>">
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input type="text" name="length" class="form-control" id="length" placeholder="Digite a duração do filme" value="<?php echo $movie->length; ?>">
               </div>
               <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="trailer" class="form-control" id="trailer" placeholder="Insira o link do trailer" value="<?php echo $movie->trailer; ?>">
                  </div>
                  <div class=" form-group">
